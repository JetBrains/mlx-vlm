...
class TestNativePackedExactCheckpoints:
    def test_uniform_roundtrip_and_merge_stay_packed(self, tmp_path, monkeypatch):
        ...
        # This fork persists only pinned seed prefixes by default; the
        # roundtrip under test is about packed-state fidelity, so opt the
        # unpinned store into the disk tier.
